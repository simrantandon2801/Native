      ...
      {({
            ...
            <View>
              ...
              <View style={styles.row}>
                <View style={styles.largeInputContainer1}>
                  ...
                  />
                  {touched.nameTitle && errors.nameTitle && (
                    <Text style={{color: 'red'}}>{errors.nameTitle}</Text>
                  )}
                </View>
                ...
                <View style={styles.smallInputContainer}>
                  ...
                  {touched.priority && errors.priority && (
                    <Text style={{color: 'red'}}>{errors.priority}</Text>
                  )}
                </View>
              ...
              <View style={styles.row}>
                ...
                <View style={styles.smallInputContainer}>
                  ...
                  {touched.projectSize && errors.projectSize && (
                    <Text style={{color: 'red'}}>{errors.projectSize}</Text>
                  )}
                </View>
              </View>
              ...
              <View style={styles.row}>
                <View style={styles.largeInputContainer1}>
                  ...
                  {touched.businessOwner && errors.businessOwner && (
                    <Text style={{color: 'red'}}>{errors.businessOwner}</Text>
                  )}
                </View>
                ...
                <View style={styles.smallInputContainer}>
                  ...
                  <NestedDeptDropdownNewProjects
                    ...
                    buisnessPersonId={parseInt(businessOwner)}
                  />
                  {touched.businessOwnerDept && errors.businessOwnerDept && (
                    <Text style={{color: 'red'}}>
                      {errors.businessOwnerDept}
                    </Text>
                  )}
                </View>
                <View style={styles.smallInputContainer}>
              ...
              <View style={styles.row}>
                <View style={styles.largeInputContainer1}>
                  ...
                  {touched.projectOwner && errors.projectOwner && (
                    <Text style={{color: 'red'}}>{errors.projectOwner}</Text>
                  )}
                </View>
                ...
                <View style={styles.smallInputContainer}>
                  ...
                  {touched.projectOwnerDept && errors.projectOwnerDept && (
                    <Text style={{color: 'red'}}>
                      {errors.projectOwnerDept}
                    </Text>
                  )}
                </View>
                <View style={styles.smallInputContainer}>
              ...
              <View style={styles.row}>
                <View style={styles.largeInputContainer1}>
                  ...
                  {touched.projectManager && errors.projectManager && (
                    <Text style={{color: 'red'}}>{errors.projectManager}</Text>
                  )}
                </View>
                <View style={styles.smallInputContainer}>
                  <Text style={styles.inputLabel}>
        ...
        <Icon name="calendar-today" size={20} color="#044086" style={styles.icon} />
              ...
              <View style={styles.row}>
                <View style={styles.smallInputContainer}>
                  ...
                  {touched.roi && errors.roi && (
                    <Text style={{color: 'red'}}>{errors.roi}</Text>
                  )}
                </View>
              ...
              <View style={styles.row5}>
                ...
                <View style={styles.halfInputContainer}>
                  <Text style={styles.inputLabel}>
                    Budget Impact<Text style={styles.asterisk}>*</Text>
                  </Text>
                  <TextInput
                    style={styles.outlinedInput}
              ...
              <View style={styles.bottomButtonsContainer}>
                <View style={styles.leftButtonContainer}>
                  <TouchableOpacity
                    style={[styles.saveAsDraftButton, {marginBottom: 20}]}
                    onPress={handleBudgetDetail}>
                    <Icon
                      name="time-outline"
                      size={18}
                      color="#044086"
          ...
          <Modal
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.modalContent}>
                ...
                <RadioButton.Group
                  onValueChange={value => setSelectedOptionApp(value)}
