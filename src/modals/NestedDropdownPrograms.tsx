...
// Main Component
const NestedDeptDropdownPrograms: React.FC<NestedDeptDropdownProps & { EditProgram: any }> = ({ onSelect, EditProgram }) => {
        ...
        <TouchableOpacity onPress={() => setDropdownVisible(!dropdownVisible)}>
          <View style={{ flexDirection: 'row' }}>
            <TextInput
              ...
              editable={false}
              placeholder={EditProgram ?  mapDepartmentIdToName(parseInt(EditProgram.stakeholders)): 'Select a department'}  // Change placeholder based on editGoal
            />
...
export default NestedDeptDropdownPrograms;