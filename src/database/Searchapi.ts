...
export const getInspectionSearchReport = async (payload: any,currentPage:number) => {
  try {
    ...
    const apiUrl = `${BASE_URL}/gateway/officer/inspection/inspectionsearchreportreg/${currentPage}`
