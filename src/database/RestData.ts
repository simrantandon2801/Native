...
export const GetUsers = async (
  ...
  try {
    // Base API endpoint
    let uri = `${BASE_URL}/master/get_users`;
...
export const GetZoneProcessingList = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/ZoneProcessing';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var jsonResult = await GetAsync_with_token(uri, token);
...
export const GetPropertyType = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/GetMasters/PropertyTypeList';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var jsonResult = await GetAsync_with_token(uri, token);
...
export const GetRegulationData = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/GetMasters/RegulationAppliesToList';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var jsonResult = await GetAsync_with_token(uri, token);
...
export const GetNeighborData = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/GetMasters/neighborList?nhotypeid=' +
      query;
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
...
export const create_Zone = async (values: Object): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/CreateNewZone';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var payload = JSON.stringify(values);
...
export const GetZoneProcessing = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/ZoneProcessing?zone_rglns_code=' +
      query;
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
...
export const create_MinimumBuild = async (values: Object): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/CreateMinimumBuild';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var payload = JSON.stringify(values);
...
export const create_MaximumBuild = async (values: Object): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/CreateMaxBuildAdu';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var payload = JSON.stringify(values);
...
export const create_MaximumBuildRangePercent = async (
  values: string,
): Promise<string> => {
  try {
    //
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation//CreateMaxBuildAduSqftRange';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var payload = JSON.stringify(values);
...
export const DeleteMaxBuildAdu = async (values: Object): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/DeleteMaxBuildAdu';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var payload = JSON.stringify(values);
...
export const DeleteZonalProcessing = async (
  values: Object,
): Promise<string> => {
  try {
    //
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/DeleteNewZone';
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
    var payload = JSON.stringify(values);
...
export const GetmaximumBuild = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/ViewMaxBuildAdu?zone_rglns_code=' +
      query;
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
...
export const fetchSubmissionsDataTable = async (
  query: string,
  val: string,
): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/ViewMaxBuildAduSqftRange?zone_rglns_code=' +
      query +
      '&max_build_id=' +
      val;
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
...
export const GetminimumBuild = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/ViewMinimumBuild?zone_rglns_code=' +
      query;
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
...
export const CreateParkingBasementDetails = async (
  values: string,
): Promise<string> => {
  try {
    //
...
export const ViewParkBaseOthers = async (query: string): Promise<string> => {
  try {
    ...
    //const UserID = await AsyncStorage.getItem('UserID');
    var uri =
      'https://underbuiltapi.aadhidigital.com/ManageZoneRegulation/ViewParkBaseOthers?zone_rglns_code=' +
      query;
    //var uri = 'https://qms.digital.logicsoft.online:8081/gateway/dilip/upload-samplecollectionimages';
    const token = await AsyncStorage.getItem('Token');
    console.log(uri);
