...
import ProceedInspection from "./src/screens/ProceedInspection"
...
function App(): React.JSX.Element {
  ...
  <Stack.Screen name="Proceed Inspection" component={ProceedInspection}  options={{ title: 'Proceed Inspection' }} />
